...
public class ShiroServiceImpl implements ShiroService {
    ...
    @Autowired
    private NfUserTokenDao nfUserTokenDao;
    ...
    @Override
    public NfUserTokenEntity queryByTokenWeb(String token) {
        return nfUserTokenDao.queryByToken(token);
    }
    ...
    @Override
    public NfUserEntity queryUserWeb(Long userId) {
        return nfUserDao.selectById(userId);
    }
}
